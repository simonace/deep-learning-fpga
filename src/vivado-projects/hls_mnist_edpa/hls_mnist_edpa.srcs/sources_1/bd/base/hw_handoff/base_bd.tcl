...
proc create_root_design { parentCell } {
  ...
  # Create instance: mnist_edp_0, and set properties
  set mnist_edp_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist_edp:1.0 mnist_edp_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mnist_edp_0/sdata_in]
  ...
  connect_bd_intf_net -intf_net mnist_edp_0_sdata_out [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins mnist_edp_0/sdata_out]
