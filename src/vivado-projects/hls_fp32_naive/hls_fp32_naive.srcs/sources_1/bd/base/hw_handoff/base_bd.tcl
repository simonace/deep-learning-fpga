...
proc create_root_design { parentCell } {
  ...
  # Create instance: mnist_fp32_naive_0, and set properties
  set mnist_fp32_naive_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mnist_fp32_naive:1.0 mnist_fp32_naive_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins mnist_fp32_naive_0/sdata_in]
  ...
  connect_bd_intf_net -intf_net mnist_fp32_naive_0_sdata_out [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins mnist_fp32_naive_0/sdata_out]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins mnist_fp32_naive_0/ap_rst_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
