...
set rc [catch {
  ...
  add_files -quiet /home/xbili/Code/FPGA/vivado-projects/hls_fp32_naive/hls_fp32_naive.runs/synth_1/base_wrapper.dcp
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file base_wrapper_timing_summary_routed.rpt -rpx base_wrapper_timing_summary_routed.rpx -warn_on_violation "
