...
#include "packer_packet_usekbM.h"
...
struct packer : public sc_module {
    ...
    sc_in< sc_lv<32> > stream_in_V_dout;
    ...
    packer_packet_usekbM* packet_user_V_U;
    packer_packet_usekbM* packet_id_V_U;
    packer_packet_usekbM* packet_dest_V_U;
    ...
    sc_signal< sc_lv<1> > ap_reg_pp0_iter1_exitcond_reg_202;
    ...
    sc_signal< sc_lv<4> > i_2_fu_178_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<1> > tmp_last_V_fu_191_p2;
    sc_signal< sc_lv<1> > tmp_last_V_reg_211;
    sc_signal< sc_lv<32> > tmp_data_V_fu_197_p1;
    ...
    void thread_tmp_data_V_fu_197_p1();
    void thread_tmp_last_V_fu_191_p2();
