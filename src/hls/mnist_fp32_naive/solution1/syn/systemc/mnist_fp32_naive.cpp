...
const sc_lv<32> mnist_fp32_naive::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<4> mnist_fp32_naive::ap_const_lv4_0 = "0000";
const sc_lv<1> mnist_fp32_naive::ap_const_lv1_0 = "0";
const sc_logic mnist_fp32_naive::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic mnist_fp32_naive::ap_const_logic_0 = sc_dt::Log_0;

mnist_fp32_naive::mnist_fp32_naive(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    unpacker_U0->stream_out_V_din(unpacker_U0_stream_out_V_din);
    unpacker_U0->stream_out_V_full_n(data_in_V_full_n);
    unpacker_U0->stream_out_V_write(unpacker_U0_stream_out_V_write);
    ...
    linear_activation_U0->data_in_V_dout(data_in_V_dout);
    linear_activation_U0->data_in_V_empty_n(data_in_V_empty_n);
    linear_activation_U0->data_in_V_read(linear_activation_U0_data_in_V_read);
    linear_activation_U0->data_out_V_din(linear_activation_U0_data_out_V_din);
    linear_activation_U0->data_out_V_full_n(l1_result_V_full_n);
    linear_activation_U0->data_out_V_write(linear_activation_U0_data_out_V_write);
    ...
    relu_U0->data_in_V_dout(l1_result_V_dout);
    relu_U0->data_in_V_empty_n(l1_result_V_empty_n);
    relu_U0->data_in_V_read(relu_U0_data_in_V_read);
    relu_U0->data_out_V_din(relu_U0_data_out_V_din);
    relu_U0->data_out_V_full_n(l1_relu_V_full_n);
    relu_U0->data_out_V_write(relu_U0_data_out_V_write);
    ...
    linear_activation_1_U0->data_in_V_dout(l1_relu_V_dout);
    linear_activation_1_U0->data_in_V_empty_n(l1_relu_V_empty_n);
    linear_activation_1_U0->data_in_V_read(linear_activation_1_U0_data_in_V_read);
    linear_activation_1_U0->data_out_V_din(linear_activation_1_U0_data_out_V_din);
    linear_activation_1_U0->data_out_V_full_n(data_out_V_full_n);
    linear_activation_1_U0->data_out_V_write(linear_activation_1_U0_data_out_V_write);
    ...
    packer_U0->stream_in_V_dout(data_out_V_dout);
    packer_U0->stream_in_V_empty_n(data_out_V_empty_n);
    packer_U0->stream_in_V_read(packer_U0_stream_in_V_read);
    ...
    data_in_V_U = new fifo_w32_d1_A("data_in_V_U");
    data_in_V_U->clk(ap_clk);
    data_in_V_U->reset(ap_rst_n_inv);
    data_in_V_U->if_read_ce(ap_var_for_const0);
    data_in_V_U->if_write_ce(ap_var_for_const0);
    data_in_V_U->if_din(unpacker_U0_stream_out_V_din);
    data_in_V_U->if_full_n(data_in_V_full_n);
    data_in_V_U->if_write(unpacker_U0_stream_out_V_write);
    data_in_V_U->if_dout(data_in_V_dout);
    data_in_V_U->if_empty_n(data_in_V_empty_n);
    data_in_V_U->if_read(linear_activation_U0_data_in_V_read);
    l1_result_V_U = new fifo_w32_d1_A("l1_result_V_U");
    l1_result_V_U->clk(ap_clk);
    l1_result_V_U->reset(ap_rst_n_inv);
    l1_result_V_U->if_read_ce(ap_var_for_const0);
    l1_result_V_U->if_write_ce(ap_var_for_const0);
    l1_result_V_U->if_din(linear_activation_U0_data_out_V_din);
    l1_result_V_U->if_full_n(l1_result_V_full_n);
    l1_result_V_U->if_write(linear_activation_U0_data_out_V_write);
    l1_result_V_U->if_dout(l1_result_V_dout);
    l1_result_V_U->if_empty_n(l1_result_V_empty_n);
    l1_result_V_U->if_read(relu_U0_data_in_V_read);
    l1_relu_V_U = new fifo_w32_d1_A("l1_relu_V_U");
    l1_relu_V_U->clk(ap_clk);
    l1_relu_V_U->reset(ap_rst_n_inv);
    l1_relu_V_U->if_read_ce(ap_var_for_const0);
    l1_relu_V_U->if_write_ce(ap_var_for_const0);
    l1_relu_V_U->if_din(relu_U0_data_out_V_din);
    l1_relu_V_U->if_full_n(l1_relu_V_full_n);
    l1_relu_V_U->if_write(relu_U0_data_out_V_write);
    l1_relu_V_U->if_dout(l1_relu_V_dout);
    l1_relu_V_U->if_empty_n(l1_relu_V_empty_n);
    l1_relu_V_U->if_read(linear_activation_1_U0_data_in_V_read);
    data_out_V_U = new fifo_w32_d1_A("data_out_V_U");
    data_out_V_U->clk(ap_clk);
    data_out_V_U->reset(ap_rst_n_inv);
    data_out_V_U->if_read_ce(ap_var_for_const0);
    data_out_V_U->if_write_ce(ap_var_for_const0);
    data_out_V_U->if_din(linear_activation_1_U0_data_out_V_din);
    data_out_V_U->if_full_n(data_out_V_full_n);
    data_out_V_U->if_write(linear_activation_1_U0_data_out_V_write);
    data_out_V_U->if_dout(data_out_V_dout);
    data_out_V_U->if_empty_n(data_out_V_empty_n);
    data_out_V_U->if_read(packer_U0_stream_in_V_read);
    ...
    apTFilenSS << "mnist_fp32_naive_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, unpacker_U0_stream_out_V_din, "unpacker_U0_stream_out_V_din");
    sc_trace(mVcdFile, unpacker_U0_stream_out_V_write, "unpacker_U0_stream_out_V_write");
    ...
    sc_trace(mVcdFile, linear_activation_U0_data_in_V_read, "linear_activation_U0_data_in_V_read");
    sc_trace(mVcdFile, linear_activation_U0_data_out_V_din, "linear_activation_U0_data_out_V_din");
    sc_trace(mVcdFile, linear_activation_U0_data_out_V_write, "linear_activation_U0_data_out_V_write");
    ...
    sc_trace(mVcdFile, relu_U0_data_in_V_read, "relu_U0_data_in_V_read");
    sc_trace(mVcdFile, relu_U0_data_out_V_din, "relu_U0_data_out_V_din");
    sc_trace(mVcdFile, relu_U0_data_out_V_write, "relu_U0_data_out_V_write");
    ...
    sc_trace(mVcdFile, linear_activation_1_U0_data_in_V_read, "linear_activation_1_U0_data_in_V_read");
    sc_trace(mVcdFile, linear_activation_1_U0_data_out_V_din, "linear_activation_1_U0_data_out_V_din");
    sc_trace(mVcdFile, linear_activation_1_U0_data_out_V_write, "linear_activation_1_U0_data_out_V_write");
    ...
    sc_trace(mVcdFile, packer_U0_stream_in_V_read, "packer_U0_stream_in_V_read");
    ...
    sc_trace(mVcdFile, data_in_V_full_n, "data_in_V_full_n");
    sc_trace(mVcdFile, data_in_V_dout, "data_in_V_dout");
    sc_trace(mVcdFile, data_in_V_empty_n, "data_in_V_empty_n");
    sc_trace(mVcdFile, l1_result_V_full_n, "l1_result_V_full_n");
    sc_trace(mVcdFile, l1_result_V_dout, "l1_result_V_dout");
    sc_trace(mVcdFile, l1_result_V_empty_n, "l1_result_V_empty_n");
    sc_trace(mVcdFile, l1_relu_V_full_n, "l1_relu_V_full_n");
    sc_trace(mVcdFile, l1_relu_V_dout, "l1_relu_V_dout");
    sc_trace(mVcdFile, l1_relu_V_empty_n, "l1_relu_V_empty_n");
    sc_trace(mVcdFile, data_out_V_full_n, "data_out_V_full_n");
    sc_trace(mVcdFile, data_out_V_dout, "data_out_V_dout");
    sc_trace(mVcdFile, data_out_V_empty_n, "data_out_V_empty_n");
    ...
    mHdltvinHandle.open("mnist_fp32_naive.hdltvin.dat");
    mHdltvoutHandle.open("mnist_fp32_naive.hdltvout.dat");
}

mnist_fp32_naive::~mnist_fp32_naive() {
    if (mVcdFile) 
...
void mnist_fp32_naive::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void mnist_fp32_naive::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void mnist_fp32_naive::thread_ap_sync_continue() {
    ap_sync_continue = ap_const_logic_0;
}

void mnist_fp32_naive::thread_linear_activation_1_U0_ap_continue() {
    linear_activation_1_U0_ap_continue = ap_const_logic_1;
}

void mnist_fp32_naive::thread_linear_activation_1_U0_ap_start() {
    linear_activation_1_U0_ap_start = start_for_linear_activation_1_U0_empty_n.read();
}

void mnist_fp32_naive::thread_linear_activation_U0_ap_continue() {
    linear_activation_U0_ap_continue = ap_const_logic_1;
}

void mnist_fp32_naive::thread_linear_activation_U0_ap_start() {
    linear_activation_U0_ap_start = start_for_linear_activation_U0_empty_n.read();
}

void mnist_fp32_naive::thread_packer_U0_ap_continue() {
    packer_U0_ap_continue = ap_const_logic_1;
}

void mnist_fp32_naive::thread_packer_U0_ap_start() {
    packer_U0_ap_start = start_for_packer_U0_empty_n.read();
}

void mnist_fp32_naive::thread_packer_U0_start_full_n() {
    packer_U0_start_full_n = ap_const_logic_1;
}

void mnist_fp32_naive::thread_packer_U0_start_write() {
    packer_U0_start_write = ap_const_logic_0;
}

void mnist_fp32_naive::thread_relu_U0_ap_continue() {
    relu_U0_ap_continue = ap_const_logic_1;
}

void mnist_fp32_naive::thread_relu_U0_ap_start() {
    relu_U0_ap_start = start_for_relu_U0_empty_n.read();
}

void mnist_fp32_naive::thread_sdata_in_TREADY() {
    sdata_in_TREADY = unpacker_U0_sdata_in_TREADY.read();
}

void mnist_fp32_naive::thread_sdata_out_TDATA() {
    sdata_out_TDATA = packer_U0_sdata_out_TDATA.read();
}

void mnist_fp32_naive::thread_sdata_out_TDEST() {
    sdata_out_TDEST = packer_U0_sdata_out_TDEST.read();
}

void mnist_fp32_naive::thread_sdata_out_TID() {
    sdata_out_TID = packer_U0_sdata_out_TID.read();
}

void mnist_fp32_naive::thread_sdata_out_TKEEP() {
    sdata_out_TKEEP = packer_U0_sdata_out_TKEEP.read();
}

void mnist_fp32_naive::thread_sdata_out_TLAST() {
    sdata_out_TLAST = packer_U0_sdata_out_TLAST.read();
}

void mnist_fp32_naive::thread_sdata_out_TSTRB() {
    sdata_out_TSTRB = packer_U0_sdata_out_TSTRB.read();
}

void mnist_fp32_naive::thread_sdata_out_TUSER() {
    sdata_out_TUSER = packer_U0_sdata_out_TUSER.read();
}

void mnist_fp32_naive::thread_sdata_out_TVALID() {
    sdata_out_TVALID = packer_U0_sdata_out_TVALID.read();
}

void mnist_fp32_naive::thread_start_for_linear_activation_1_U0_din() {
    start_for_linear_activation_1_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_fp32_naive::thread_start_for_linear_activation_U0_din() {
    start_for_linear_activation_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_fp32_naive::thread_start_for_packer_U0_din() {
    start_for_packer_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_fp32_naive::thread_start_for_relu_U0_din() {
    start_for_relu_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_fp32_naive::thread_unpacker_U0_ap_continue() {
    unpacker_U0_ap_continue = ap_const_logic_1;
}

void mnist_fp32_naive::thread_unpacker_U0_ap_start() {
    unpacker_U0_ap_start = ap_const_logic_1;
}

void mnist_fp32_naive::thread_hdltv_gen() {
