...
#ifndef _mnist_fp32_naive_HH_
#define _mnist_fp32_naive_HH_
...
struct mnist_fp32_naive : public sc_module {
    ...
    // Module declarations
    mnist_fp32_naive(sc_module_name name);
    SC_HAS_PROCESS(mnist_fp32_naive);
    ...
    sc_signal< sc_lv<32> > unpacker_U0_stream_out_V_din;
    sc_signal< sc_logic > unpacker_U0_stream_out_V_write;
    ...
    sc_signal< sc_logic > linear_activation_U0_data_in_V_read;
    sc_signal< sc_lv<32> > linear_activation_U0_data_out_V_din;
    sc_signal< sc_logic > linear_activation_U0_data_out_V_write;
    ...
    sc_signal< sc_logic > relu_U0_data_in_V_read;
    sc_signal< sc_lv<32> > relu_U0_data_out_V_din;
    sc_signal< sc_logic > relu_U0_data_out_V_write;
    ...
    sc_signal< sc_logic > linear_activation_1_U0_data_in_V_read;
    sc_signal< sc_lv<32> > linear_activation_1_U0_data_out_V_din;
    sc_signal< sc_logic > linear_activation_1_U0_data_out_V_write;
    ...
    sc_signal< sc_logic > packer_U0_stream_in_V_read;
    ...
    sc_signal< sc_logic > data_in_V_full_n;
    sc_signal< sc_lv<32> > data_in_V_dout;
    sc_signal< sc_logic > data_in_V_empty_n;
    sc_signal< sc_logic > l1_result_V_full_n;
    sc_signal< sc_lv<32> > l1_result_V_dout;
    sc_signal< sc_logic > l1_result_V_empty_n;
    sc_signal< sc_logic > l1_relu_V_full_n;
    sc_signal< sc_lv<32> > l1_relu_V_dout;
    sc_signal< sc_logic > l1_relu_V_empty_n;
    sc_signal< sc_logic > data_out_V_full_n;
    sc_signal< sc_lv<32> > data_out_V_dout;
    sc_signal< sc_logic > data_out_V_empty_n;
