...
architecture behav of mnist_fp32_naive is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "mnist_fp32_naive,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.427200,HLS_SYN_LAT=4004,HLS_SYN_TPT=4004,HLS_SYN_MEM=124,HLS_SYN_DSP=75,HLS_SYN_FF=15170,HLS_SYN_LUT=15414}";
    ...
    signal unpacker_U0_stream_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal unpacker_U0_stream_out_V_write : STD_LOGIC;
    ...
    signal linear_activation_U0_data_in_V_read : STD_LOGIC;
    signal linear_activation_U0_data_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal linear_activation_U0_data_out_V_write : STD_LOGIC;
    ...
    signal relu_U0_data_in_V_read : STD_LOGIC;
    signal relu_U0_data_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal relu_U0_data_out_V_write : STD_LOGIC;
    ...
    signal linear_activation_1_U0_data_in_V_read : STD_LOGIC;
    signal linear_activation_1_U0_data_out_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal linear_activation_1_U0_data_out_V_write : STD_LOGIC;
    ...
    signal packer_U0_stream_in_V_read : STD_LOGIC;
    signal packer_U0_sdata_out_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal packer_U0_sdata_out_TVALID : STD_LOGIC;
    signal packer_U0_sdata_out_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal packer_U0_sdata_out_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal data_in_V_full_n : STD_LOGIC;
    signal data_in_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal data_in_V_empty_n : STD_LOGIC;
    signal l1_result_V_full_n : STD_LOGIC;
    signal l1_result_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal l1_result_V_empty_n : STD_LOGIC;
    signal l1_relu_V_full_n : STD_LOGIC;
    signal l1_relu_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal l1_relu_V_empty_n : STD_LOGIC;
    signal data_out_V_full_n : STD_LOGIC;
    signal data_out_V_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal data_out_V_empty_n : STD_LOGIC;
    ...
    port (
        ...
        sdata_in_TID : IN STD_LOGIC_VECTOR (0 downto 0);
        sdata_in_TDEST : IN STD_LOGIC_VECTOR (0 downto 0);
        stream_out_V_din : OUT STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    port map (
        ...
        stream_out_V_din => unpacker_U0_stream_out_V_din,
        stream_out_V_full_n => data_in_V_full_n,
        stream_out_V_write => unpacker_U0_stream_out_V_write);
    ...
    port map (
        ...
        data_in_V_read => linear_activation_U0_data_in_V_read,
        data_out_V_din => linear_activation_U0_data_out_V_din,
        data_out_V_full_n => l1_result_V_full_n,
        data_out_V_write => linear_activation_U0_data_out_V_write);
    ...
    port map (
        ...
        data_in_V_dout => l1_result_V_dout,
        data_in_V_empty_n => l1_result_V_empty_n,
        data_in_V_read => relu_U0_data_in_V_read,
        data_out_V_din => relu_U0_data_out_V_din,
        data_out_V_full_n => l1_relu_V_full_n,
        data_out_V_write => relu_U0_data_out_V_write);
    ...
    port map (
        ...
        data_in_V_dout => l1_relu_V_dout,
        data_in_V_empty_n => l1_relu_V_empty_n,
        data_in_V_read => linear_activation_1_U0_data_in_V_read,
        data_out_V_din => linear_activation_1_U0_data_out_V_din,
        data_out_V_full_n => data_out_V_full_n,
        data_out_V_write => linear_activation_1_U0_data_out_V_write);
    ...
    port map (
        ...
        stream_in_V_dout => data_out_V_dout,
        stream_in_V_empty_n => data_out_V_empty_n,
        stream_in_V_read => packer_U0_stream_in_V_read,
    ...
    data_in_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => unpacker_U0_stream_out_V_din,
        if_full_n => data_in_V_full_n,
        if_write => unpacker_U0_stream_out_V_write,
        if_dout => data_in_V_dout,
        if_empty_n => data_in_V_empty_n,
        if_read => linear_activation_U0_data_in_V_read);

    l1_result_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => linear_activation_U0_data_out_V_din,
        if_full_n => l1_result_V_full_n,
        if_write => linear_activation_U0_data_out_V_write,
        if_dout => l1_result_V_dout,
        if_empty_n => l1_result_V_empty_n,
        if_read => relu_U0_data_in_V_read);

    l1_relu_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => relu_U0_data_out_V_din,
        if_full_n => l1_relu_V_full_n,
        if_write => relu_U0_data_out_V_write,
        if_dout => l1_relu_V_dout,
        if_empty_n => l1_relu_V_empty_n,
        if_read => linear_activation_1_U0_data_in_V_read);

    data_out_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => linear_activation_1_U0_data_out_V_din,
        if_full_n => data_out_V_full_n,
        if_write => linear_activation_1_U0_data_out_V_write,
        if_dout => data_out_V_dout,
        if_empty_n => data_out_V_empty_n,
        if_read => packer_U0_stream_in_V_read);
