...
const Port_Property HLS_Design_Meta::port_props[]={
	Port_Property("sdata_in_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("sdata_in_TKEEP", 4, hls_in, 1, "axis", "in_data", 1),
	Port_Property("sdata_in_TSTRB", 4, hls_in, 2, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "mnist_fp32_naive";
