...
set C_modelArgList {
	{ stream_in_V_data_V int 32 regular {axi_s 0 volatile  { sdata_in Data } }  }
	{ stream_in_V_keep_V int 4 regular {axi_s 0 volatile  { sdata_in Keep } }  }
	{ stream_in_V_strb_V int 4 regular {axi_s 0 volatile  { sdata_in Strb } }  }
	...
	{ stream_out_V float 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "stream_in_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_out_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_out_V_din sc_out sc_lv 32 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sdata_in_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "stream_in_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "sdata_in_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "stream_in_V_keep_V", "role": "default" }} , 
 	{ "name": "sdata_in_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "stream_in_V_strb_V", "role": "default" }} , 
 	...
 	{ "name": "stream_out_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "stream_out_V", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "stream_out_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	stream_in_V_data_V { axis {  { sdata_in_TDATA in_data 0 32 } } }
	stream_in_V_keep_V { axis {  { sdata_in_TKEEP in_data 0 4 } } }
	stream_in_V_strb_V { axis {  { sdata_in_TSTRB in_data 0 4 } } }
	...
	stream_out_V { ap_fifo {  { stream_out_V_din fifo_data 1 32 }  { stream_out_V_full_n fifo_status 0 1 }  { stream_out_V_write fifo_update 1 1 } } }
}
