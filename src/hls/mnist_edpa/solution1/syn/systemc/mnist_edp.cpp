...
const sc_lv<16> mnist_edp::ap_const_lv16_0 = "0000000000000000";
const sc_lv<2> mnist_edp::ap_const_lv2_0 = "00";
const sc_lv<1> mnist_edp::ap_const_lv1_0 = "0";
const sc_logic mnist_edp::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic mnist_edp::ap_const_logic_0 = sc_dt::Log_0;

mnist_edp::mnist_edp(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    data_in_V_V_U = new fifo_w16_d1_A("data_in_V_V_U");
    ...
    l1_result_V_V_U = new fifo_w16_d1_A("l1_result_V_V_U");
    ...
    l1_relu_V_V_U = new fifo_w16_d1_A("l1_relu_V_V_U");
    ...
    data_out_V_V_U = new fifo_w16_d1_A("data_out_V_V_U");
    ...
    start_for_linear_kbM_U = new start_for_linear_kbM("start_for_linear_kbM_U");
    start_for_linear_kbM_U->clk(ap_clk);
    start_for_linear_kbM_U->reset(ap_rst_n_inv);
    start_for_linear_kbM_U->if_read_ce(ap_var_for_const0);
    start_for_linear_kbM_U->if_write_ce(ap_var_for_const0);
    start_for_linear_kbM_U->if_din(start_for_linear_activation_U0_din);
    start_for_linear_kbM_U->if_full_n(start_for_linear_activation_U0_full_n);
    start_for_linear_kbM_U->if_write(unpacker_U0_start_write);
    start_for_linear_kbM_U->if_dout(start_for_linear_activation_U0_dout);
    start_for_linear_kbM_U->if_empty_n(start_for_linear_activation_U0_empty_n);
    start_for_linear_kbM_U->if_read(linear_activation_U0_ap_ready);
    ...
    start_for_linear_lbW_U = new start_for_linear_lbW("start_for_linear_lbW_U");
    start_for_linear_lbW_U->clk(ap_clk);
    start_for_linear_lbW_U->reset(ap_rst_n_inv);
    start_for_linear_lbW_U->if_read_ce(ap_var_for_const0);
    start_for_linear_lbW_U->if_write_ce(ap_var_for_const0);
    start_for_linear_lbW_U->if_din(start_for_linear_activation_1_U0_din);
    start_for_linear_lbW_U->if_full_n(start_for_linear_activation_1_U0_full_n);
    start_for_linear_lbW_U->if_write(relu_U0_start_write);
    start_for_linear_lbW_U->if_dout(start_for_linear_activation_1_U0_dout);
    start_for_linear_lbW_U->if_empty_n(start_for_linear_activation_1_U0_empty_n);
    start_for_linear_lbW_U->if_read(linear_activation_1_U0_ap_ready);
    ...
    apTFilenSS << "mnist_edp_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("mnist_edp.hdltvin.dat");
    mHdltvoutHandle.open("mnist_edp.hdltvout.dat");
}
...
mnist_edp::~mnist_edp() {
    ...
    delete start_for_linear_kbM_U;
    delete start_for_relu_U0_U;
    delete start_for_linear_lbW_U;
    delete start_for_packer_U0_U;
}

void mnist_edp::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void mnist_edp::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void mnist_edp::thread_ap_sync_continue() {
    ap_sync_continue = ap_const_logic_0;
}

void mnist_edp::thread_linear_activation_1_U0_ap_continue() {
    linear_activation_1_U0_ap_continue = ap_const_logic_1;
}

void mnist_edp::thread_linear_activation_1_U0_ap_start() {
    linear_activation_1_U0_ap_start = start_for_linear_activation_1_U0_empty_n.read();
}

void mnist_edp::thread_linear_activation_U0_ap_continue() {
    linear_activation_U0_ap_continue = ap_const_logic_1;
}

void mnist_edp::thread_linear_activation_U0_ap_start() {
    linear_activation_U0_ap_start = start_for_linear_activation_U0_empty_n.read();
}

void mnist_edp::thread_packer_U0_ap_continue() {
    packer_U0_ap_continue = ap_const_logic_1;
}

void mnist_edp::thread_packer_U0_ap_start() {
    packer_U0_ap_start = start_for_packer_U0_empty_n.read();
}

void mnist_edp::thread_packer_U0_start_full_n() {
    packer_U0_start_full_n = ap_const_logic_1;
}

void mnist_edp::thread_packer_U0_start_write() {
    packer_U0_start_write = ap_const_logic_0;
}

void mnist_edp::thread_relu_U0_ap_continue() {
    relu_U0_ap_continue = ap_const_logic_1;
}

void mnist_edp::thread_relu_U0_ap_start() {
    relu_U0_ap_start = start_for_relu_U0_empty_n.read();
}

void mnist_edp::thread_sdata_in_TREADY() {
    sdata_in_TREADY = unpacker_U0_sdata_in_TREADY.read();
}

void mnist_edp::thread_sdata_out_TDATA() {
    sdata_out_TDATA = packer_U0_sdata_out_TDATA.read();
}

void mnist_edp::thread_sdata_out_TDEST() {
    sdata_out_TDEST = packer_U0_sdata_out_TDEST.read();
}

void mnist_edp::thread_sdata_out_TID() {
    sdata_out_TID = packer_U0_sdata_out_TID.read();
}

void mnist_edp::thread_sdata_out_TKEEP() {
    sdata_out_TKEEP = packer_U0_sdata_out_TKEEP.read();
}

void mnist_edp::thread_sdata_out_TLAST() {
    sdata_out_TLAST = packer_U0_sdata_out_TLAST.read();
}

void mnist_edp::thread_sdata_out_TSTRB() {
    sdata_out_TSTRB = packer_U0_sdata_out_TSTRB.read();
}

void mnist_edp::thread_sdata_out_TUSER() {
    sdata_out_TUSER = packer_U0_sdata_out_TUSER.read();
}

void mnist_edp::thread_sdata_out_TVALID() {
    sdata_out_TVALID = packer_U0_sdata_out_TVALID.read();
}

void mnist_edp::thread_start_for_linear_activation_1_U0_din() {
    start_for_linear_activation_1_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_edp::thread_start_for_linear_activation_U0_din() {
    start_for_linear_activation_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_edp::thread_start_for_packer_U0_din() {
    start_for_packer_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_edp::thread_start_for_relu_U0_din() {
    start_for_relu_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void mnist_edp::thread_unpacker_U0_ap_continue() {
    unpacker_U0_ap_continue = ap_const_logic_1;
}

void mnist_edp::thread_unpacker_U0_ap_start() {
    unpacker_U0_ap_start = ap_const_logic_1;
}

void mnist_edp::thread_hdltv_gen() {
