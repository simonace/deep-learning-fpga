...
#ifndef __mnist_edp_mul_mulbkb__HH__
#define __mnist_edp_mul_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mnist_edp_mul_mulbkb) {
    ...
    SC_CTOR(mnist_edp_mul_mulbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
