...
const Port_Property HLS_Design_Meta::port_props[]={
	Port_Property("sdata_in_TDATA", 16, hls_in, 0, "axis", "in_data", 1),
	Port_Property("sdata_in_TKEEP", 2, hls_in, 1, "axis", "in_data", 1),
	Port_Property("sdata_in_TSTRB", 2, hls_in, 2, "axis", "in_data", 1),
	...
	Port_Property("sdata_out_TDATA", 16, hls_out, 7, "axis", "out_data", 1),
	Port_Property("sdata_out_TKEEP", 2, hls_out, 8, "axis", "out_data", 1),
	Port_Property("sdata_out_TSTRB", 2, hls_out, 9, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "mnist_edp";
