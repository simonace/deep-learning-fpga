...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sdata_in_TVALID { I 1 bit } sdata_in_TREADY { O 1 bit } sdata_in_TDEST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out_V_V_din { O 8 vector } stream_out_V_V_full_n { I 1 bit } stream_out_V_V_write { O 1 bit } } \
} "
}
