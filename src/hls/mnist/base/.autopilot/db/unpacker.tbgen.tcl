...
set C_modelArgList {
	{ stream_in_V_data_V int 8 regular {axi_s 0 volatile  { sdata_in Data } }  }
	{ stream_in_V_keep_V int 1 regular {axi_s 0 volatile  { sdata_in Keep } }  }
	{ stream_in_V_strb_V int 1 regular {axi_s 0 volatile  { sdata_in Strb } }  }
	...
	{ stream_out_V_V int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "stream_in_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_out_V_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_out_V_V_din sc_out sc_lv 8 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sdata_in_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "stream_in_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "sdata_in_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_in_V_keep_V", "role": "default" }} , 
 	{ "name": "sdata_in_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_in_V_strb_V", "role": "default" }} , 
 	...
 	{ "name": "stream_out_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "stream_out_V_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	stream_in_V_data_V { axis {  { sdata_in_TDATA in_data 0 8 } } }
	stream_in_V_keep_V { axis {  { sdata_in_TKEEP in_data 0 1 } } }
	stream_in_V_strb_V { axis {  { sdata_in_TSTRB in_data 0 1 } } }
	...
	stream_out_V_V { ap_fifo {  { stream_out_V_V_din fifo_data 1 8 }  { stream_out_V_V_full_n fifo_status 0 1 }  { stream_out_V_V_write fifo_update 1 1 } } }
}
