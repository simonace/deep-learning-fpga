...
#ifndef __mnist_mac_muladd_fYi__HH__
#define __mnist_mac_muladd_fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mnist_mac_muladd_fYi) {
    ...
    SC_CTOR(mnist_mac_muladd_fYi):  simcore_mac_1_U ("simcore_mac_1_U") {
