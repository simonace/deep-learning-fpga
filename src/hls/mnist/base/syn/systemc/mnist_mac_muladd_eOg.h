...
#ifndef __mnist_mac_muladd_eOg__HH__
#define __mnist_mac_muladd_eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mnist_mac_muladd_eOg) {
    ...
    SC_CTOR(mnist_mac_muladd_eOg):  simcore_mac_0_U ("simcore_mac_0_U") {
