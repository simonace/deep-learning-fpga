...
struct unpacker : public sc_module {
    ...
    sc_out< sc_lv<8> > stream_out_V_V_din;
    ...
    sc_signal< sc_lv<8> > stream_in_V_data_V_0_data_out;
    ...
    sc_signal< sc_lv<8> > stream_in_V_data_V_0_payload_A;
    sc_signal< sc_lv<8> > stream_in_V_data_V_0_payload_B;
    ...
    sc_signal< sc_lv<1> > exitcond_reg_125;
