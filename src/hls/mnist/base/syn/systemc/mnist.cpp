...
mnist::mnist(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    start_for_linear_lbW_U->if_din(start_for_linear_activation_U0_din);
    start_for_linear_lbW_U->if_full_n(start_for_linear_activation_U0_full_n);
    start_for_linear_lbW_U->if_write(unpacker_U0_start_write);
    start_for_linear_lbW_U->if_dout(start_for_linear_activation_U0_dout);
    start_for_linear_lbW_U->if_empty_n(start_for_linear_activation_U0_empty_n);
    start_for_linear_lbW_U->if_read(linear_activation_U0_ap_ready);
    ...
    start_for_linear_mb6_U->if_din(start_for_linear_activation_1_U0_din);
    start_for_linear_mb6_U->if_full_n(start_for_linear_activation_1_U0_full_n);
    start_for_linear_mb6_U->if_write(relu_U0_start_write);
    start_for_linear_mb6_U->if_dout(start_for_linear_activation_1_U0_dout);
    start_for_linear_mb6_U->if_empty_n(start_for_linear_activation_1_U0_empty_n);
    start_for_linear_mb6_U->if_read(linear_activation_1_U0_ap_ready);
