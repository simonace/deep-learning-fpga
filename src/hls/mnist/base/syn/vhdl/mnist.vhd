...
entity mnist is
port (
    sdata_in_TDATA : IN STD_LOGIC_VECTOR (7 downto 0);
    sdata_in_TKEEP : IN STD_LOGIC_VECTOR (0 downto 0);
    sdata_in_TSTRB : IN STD_LOGIC_VECTOR (0 downto 0);
...
architecture behav of mnist is 
    ...
    signal unpacker_U0_stream_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal linear_activation_U0_data_out_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal relu_U0_data_out_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal linear_activation_1_U0_data_out_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    port (
        ...
        sdata_in_TID : IN STD_LOGIC_VECTOR (0 downto 0);
        sdata_in_TDEST : IN STD_LOGIC_VECTOR (0 downto 0);
        stream_out_V_V_din : OUT STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    data_in_V_V_U : component fifo_w8_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    l1_result_V_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    l1_relu_V_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    data_out_V_V_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
