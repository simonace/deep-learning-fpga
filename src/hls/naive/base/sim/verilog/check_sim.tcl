...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.neural_network.autotvin_mem_V.dat"
         "c.neural_network.autotvin_w1_offset.dat"
         "c.neural_network.autotvin_w2_offset.dat"
         "c.neural_network.autotvin_input_offset.dat"
         "c.neural_network.autotvin_b1_offset.dat"
         "c.neural_network.autotvin_b2_offset.dat"
         "c.neural_network.autotvin_result_offset.dat"
         "c.neural_network.autotvout_out_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.neural_network.autotvout_out_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
