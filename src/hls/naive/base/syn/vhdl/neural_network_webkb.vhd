...
entity neural_network_webkb_ram is 
    generic(
...
architecture rtl of neural_network_webkb_ram is 
...
entity neural_network_webkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of neural_network_webkb is
    component neural_network_webkb_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    neural_network_webkb_ram_U :  component neural_network_webkb_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
