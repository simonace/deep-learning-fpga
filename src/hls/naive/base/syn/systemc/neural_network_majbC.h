...
#ifndef __neural_network_majbC__HH__
#define __neural_network_majbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(neural_network_majbC) {
    ...
    SC_CTOR(neural_network_majbC):  simcore_mac_0_U ("simcore_mac_0_U") {
