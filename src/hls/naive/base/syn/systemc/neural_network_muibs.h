...
#ifndef __neural_network_muibs__HH__
#define __neural_network_muibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(neural_network_muibs) {
    ...
    SC_CTOR(neural_network_muibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
