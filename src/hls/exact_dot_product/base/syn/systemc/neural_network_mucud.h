...
#ifndef __neural_network_mucud__HH__
#define __neural_network_mucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(neural_network_mucud) {
    ...
    SC_CTOR(neural_network_mucud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
