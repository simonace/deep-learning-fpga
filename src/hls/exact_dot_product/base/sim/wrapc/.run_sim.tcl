...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "neural_network.autotvin.dat"
	set constFileTvOut       "neural_network.autotvout.dat"
	set constFileHdlTvIn     "neural_network.autohdltvin.dat"
	set constFileHdlTvOut    "neural_network.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
